...
public final class Reminders extends JavaPlugin {
    ...
    public void loadConfig(){
        ...
        storeBookText = config.getString("store_book_text", "\nCheck out our store https://chum-community-store-front.tebex.io/");
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        else if(label.equalsIgnoreCase("blake")){
            sender.sendMessage("where blake goes sillyness follows");
        }else if (label.equalsIgnoreCase("store")){
            sender.sendMessage(storeBookText);
        }
        return false;
    }
}
